...
The UI should use CheckpointSessionMetadata.createdAt to sort the summaries

### Prompt 27

Does the UI also know to merge the summary events in the right order?

### Prompt 28

Don't call the old v1 api. Call the new v2 api
